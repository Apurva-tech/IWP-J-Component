...
ALTER TABLE Intern ADD CONSTRAINT check_graduationyear_range CHECK(graduationYear >= '1950-00-0000');
...
ALTER TABLE InternPosNeeded ADD CONSTRAINT pk_internposneeded PRIMARY KEY(startupEmail); 
